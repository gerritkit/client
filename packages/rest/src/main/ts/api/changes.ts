...
export function changeEndpoints({
  ...
  return {
    ...
    async deleteTopic({ args: { changeId } }: { args: { changeId: string } }) {
      return axios({
        method: 'DELETE',
        url: `${baseUrl}/changes/${changeId}/topic`,
        auth,
    ...
    async getAssignee({ args: { changeId } }: { args: { changeId: string } }) {
      return axios({
        method: 'GET',
    ...
    async rebaseChange({ args: { changeId } }: { args: { changeId: string } }) {
      return axios({
        method: 'POST',
    ...
    async revertSubmission({
      ...
      return axios({
        ...
        auth,
        params: {},
      }).then(({ data }) => parseGerritResponse(data) as TRevertSubmissionInfo)
    },
    ...
    async changesSubmittedTogether({
      ...
      return axios({
        ...
        auth,
        params: {},
      }).then(({ data }) => parseGerritResponse(data) as TSubmittedTogetherInfo)
    },

    async deleteChange({ args: { changeId } }: { args: { changeId: string } }) {
      return axios({
        method: 'DELETE',
        url: `${baseUrl}/changes/${changeId}`,
        auth,
    ...
    async indexChange({ args: { changeId } }: { args: { changeId: string } }) {
      return axios({
        method: 'POST',
    ...
    async checkChange({ args: { changeId } }: { args: { changeId: string } }) {
      return axios({
        method: 'GET',
    ...
    async getHashtags({ args: { changeId } }: { args: { changeId: string } }) {
      return axios({
        method: 'GET',
